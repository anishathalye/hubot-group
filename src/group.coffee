...
#   HUBOT_GROUP_PREPEND_MSG - prepends original message to response
#     Set to true to enable. This variable can also be left
#     unset (or be the empty string).
#
# Commands:
...
module.exports = (robot) ->
  ...
  robot.hear ///@#{IDENTIFIER}///, (res) ->
    ...
    if response.length > 0
      if process.env.HUBOT_GROUP_PREPEND_MSG
